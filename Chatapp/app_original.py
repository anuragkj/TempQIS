...
base_url = "http://127.0.0.1:3895" # If you deployed locally
...
llm = AzureChatOpenAI(deployment_name=os.environ["AZURE_OPENAI_MODEL"], temperature=0, max_tokens=COMPLETION_TOKENS, streaming=True, callback_manager=cb_manager, api_version="2024-05-01-preview")

## Azure AI Search Agent
doc_indexes = ["qis-index-combined"]
...
async def stream_chat_request(request_body, request_headers):
    ...
    async def generate():
        ...
        async for event in response:
            ...
            # Stream df or docsearch based answer
...
async def ensure_cosmos():
    print(app_settings.chat_history)
    await cosmos_db_ready.wait()
...
if __name__ == "__main__":
    uvicorn.run("app:fastapi_app", host="127.0.0.1", port=3895, reload=True)