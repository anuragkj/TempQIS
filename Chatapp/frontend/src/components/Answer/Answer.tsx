...
import { ThumbDislike20Filled, ThumbLike20Filled, CopyRegular, ThumbLike20Regular } from '@fluentui/react-icons'
...
export const Answer = ({ answer, onCitationClicked, onExectResultClicked }: Props) => {
    ...
    return (
      <>
        ...
        <Stack tokens={{ childrenGap: 4 }}>
          <Checkbox
            label="Citations are missing / wrong"
          ...
          <Checkbox
            label="Answer contains sensitive information"
  ...
  const handleCopyClick = (ans?:string) => {
    ...
    <>
      ...
      <Stack.Item className={styles.answerDisclaimerContainer} >
          <div
            ...
            tabIndex={0}
            aria-label="Copy"
            onClick={e => handleCopyClick(parsedAnswer?.markdownFormatText)}
            // onClick={e => console.log(markdownToTxt(parsedAnswer?.markdownFormatText || ''))}
            onKeyDown={e => (e.key === 'Enter' || e.key === ' ' ? handleCopyClick() : null)}>
            <CopyRegular className={styles.copyButton} />
            <span className={styles.copyButtonText}>Copy Text</span>
          </div>
        </Stack.Item>
        <Stack.Item>
          <Stack horizontal grow>
            <Stack.Item grow id={answer.message_id}>
        ...
        <Stack horizontal className={styles.answerFooter}>
          ...
          {FEEDBACK_ENABLED && answer.message_id !== undefined && (
                <Stack horizontal horizontalAlign="space-between">
                    {(Feedback.Positive && appStateContext?.state.feedbackState[answer.message_id] === Feedback.Positive) && 
                    <FontIcon 
                      aria-hidden="false"
                      ...
                      iconName="LikeSolid"  
                      style={
                        {color: '#099053', fontSize: '20px', cursor: 'pointer'}
                      } 
                    />
                    }
                    {!(Feedback.Positive && appStateContext?.state.feedbackState[answer.message_id] === Feedback.Positive) && 
                    <FontIcon 
                      ...
                      iconName="Like"  
                      style={
                      {color: 'darkgrey', fontSize: '20px', cursor: 'pointer'}
                      } 
                    />
                    }
                    ...
                    <FontIcon 
                      ...
                      style={
                      {color: '#A7070F', fontSize: '20px', cursor: 'pointer', marginLeft: '7px'}
                      } 
                    />
                    }
                    {!(feedbackState !== Feedback.Positive &&
                    ...
                    <FontIcon 
                      ...
                      iconName="Dislike"  
                      style={
                      {color: 'darkgrey', fontSize: '20px', cursor: 'pointer', marginLeft: '7px'}
                      } 
                    />
                    }
                </Stack>
