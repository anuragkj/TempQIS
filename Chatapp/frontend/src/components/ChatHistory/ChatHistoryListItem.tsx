...
export const ChatHistoryListItemCell: React.FC<ChatHistoryListItemCellProps> = ({ item, onSelect }) => {
  ...
  return (
    <Stack
      ...
      styles={{
        root: {
          backgroundColor: isSelected ? '#ADA9C2' : 'transparent',
          color: isSelected ? 'white' : '#1B1534'
        }
      }}>
      {edit ? (
        <>
                  ...
                  <Stack.Item>
                    <Stack aria-label="action button group" horizontal verticalAlign={'center'}>
                      <IconButton
                        ...
                        // styles={{ root: { color: '#14DA79', marginLeft: '5px' } }}
                      ...
                      <IconButton
                        ...
                        // styles={{ root: { color: '#E85960', marginLeft: '5px' } }}
      ...
      <Dialog
        ...
        <DialogFooter>
          <DefaultButton onClick={toggleDeleteDialog} text="Cancel" className={styles.defaultButton} />
          <PrimaryButton onClick={onDelete} text="Delete" className={styles.primaryButton}/>
        </DialogFooter>
      </Dialog>
    </Stack>
  )
