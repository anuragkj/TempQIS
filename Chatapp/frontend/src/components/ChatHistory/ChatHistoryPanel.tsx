...
export function ChatHistoryPanel(_props: ChatHistoryPanelProps) {
  ...
  const menuItems: IContextualMenuItem[] = [
    { key: 'clearAll', text: 'Clear all chat history', iconProps: { iconName: 'Delete' }, className: styles.historyPanelContextMenu }
  ]
        ...
        <Stack verticalAlign="start">
          <Stack horizontal styles={commandBarButtonStyle}>
            <CommandBarButton
              ...
              className={styles.historyPanelButtons}
              role="button"
              id="moreButton"
            />
            <ContextualMenu
      ...
      <Dialog
        ...
        <DialogFooter>
          <DefaultButton
            ...
            />
            {!clearingError && <PrimaryButton onClick={onClearAllChatHistory} disabled={clearing} text="Clear All" className={styles.primaryButton} />}
        </DialogFooter>
      </Dialog>
    </section>
  )
